<%@ Page Title="" Language="C#" MasterPageFile="~/OUnobookinghome.master" AutoEventWireup="true" CodeFile="afterloggedinOUnobooking.aspx.cs" Inherits="afterloggedinOUnobooking" %>
    ...
    <body >
        <div>
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate><div id="welcometext">Hi Again<asp:Label ID="name" runat="server" Text=""></asp:Label>!</div>
