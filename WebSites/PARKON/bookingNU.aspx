<%@ Page Title="" Language="C#" MasterPageFile="~/afterloggedinNU.master" AutoEventWireup="true" CodeFile="bookingNU.aspx.cs" Inherits="bookingNU" %>
                        ...
                        <table border="0" cellspacing="15">
                            ...
                            <caption>
                                ...
                                <tr>
                                    ...
                                    <td></td>
                                    <td>
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="bphone" ErrorMessage="Phone No not Proper" ForeColor="Red" ValidationExpression="^[0-9]\d{9}$"></asp:RegularExpressionValidator>

                                    </td>
                                    <td>
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="bvhno1" Display="Dynamic" ErrorMessage="Invalid Vehicle No" ForeColor="Red" ValidationExpression="^[a-zA-z]{2}\d{2}[a-zA-Z]{2}\d{4}"></asp:RegularExpressionValidator>
                                    </td>
                                </tr>
                    </fieldset>
