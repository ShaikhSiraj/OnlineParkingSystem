...
public partial class farechartOUnobooking : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Session["email"] == null)
        {
            Response.Redirect("farechart.aspx");
        }
        try
        {
            ...
            if (presencebr > 0)
            {
                Response.Redirect("farechartOU.aspx");
            }
            ...
            {
              //  Response.Redirect("farechartOUnobooking.aspx");
            }
            ...
            {
                Response.Redirect("farechartNU.aspx");
            }
            con.Close();
        }
        catch (Exception)
